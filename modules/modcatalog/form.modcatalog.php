...
$localFilesProduct = [];
$localFilesProductValue = [];
$localFilesProductValueStr = "";
...
if($n_id >0){
    ...
    $localFilesProductValueStr = json_encode($localFilesProductValue);
}
...
if ($action == "edit") {
    ...
    <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="priceForm"
          id="priceForm">
        ...
        <input type="hidden" name="localFiles" id="productLocalFiles" value="<?= $localFilesProductValueStr?>">
        ...
        <DIV id="formtabs" style="border:0; background: none;" class="wp100">
            ...
            <UL>
                ...
                <Li><A href="#tab-form-4">Файлы</A></Li>
            </UL>
            ...
            <div id="tabse" style="overflow-x: hidden; overflow-y: auto;">
                ...
                <div id="tab-form-3">
                    ...
                    <div class="row">
                        ...
                        <div class="column12 grid-4">
                            <label for="price_in"></label><input name="price_in" id="price_in" class="required w160"
                                                                 type="text"
                                                                 value="<?= num_format($price_in) ?>">&nbsp;<?= $valuta ?>
                        </div>
                        ...
                        <?php if (in_array('price_1', $don)) { ?>
                            ...
                            <div class="column12 grid-10">
                                <input name="price_1" type="text" id="price_1" autocomplete="off"
                                       value="<?= num_format($price_1) ?>" class="w160">&nbsp;<?= $valuta ?>
                            </div>
                        <?php } ?>
                        ...
                        <?php if (in_array('price_2', $don)) { ?>
                            ...
                            <div class="column12 grid-4">
                                <input name="price_2" type="text" id="price_2" autocomplete="off"
                                       value="<?= num_format($price_2) ?>" class="w160">&nbsp;<?= $valuta ?>
                            </div>
                        <?php } ?>
                        ...
                        <?php if (in_array('price_3', $don)) { ?>
                            ...
                            <div class="column12 grid-4">
                                <input name="price_3" type="text" id="price_3" autocomplete="off"
                                       value="<?= num_format($price_3) ?>" class="w160">&nbsp;<?= $valuta ?>
                            </div>
                        <?php } ?>
                        ...
                        <?php if (in_array('price_4', $don)) { ?>
                            ...
                            <div class="column12 grid-4">
                                <input name="price_4" type="text" id="price_4" autocomplete="off"
                                       value="<?= num_format($price_4) ?>" class="w160">&nbsp;<?= $valuta ?>
                            </div>
                        <?php } ?>
                        ...
                        <?php if (in_array('price_5', $don)) { ?>
                            ...
                            <div class="column12 grid-4">
                                <input name="price_5" type="text" id="price_5" autocomplete="off"
                                       value="<?= num_format($price_5) ?>" class="w160">&nbsp;<?= $valuta ?>
                            </div>
                        <?php } ?>
                    ...
                    <div class="row">
                        ...
                        <div class="viewdiv wp100">
                            ...
                            if ($diskLimit == 0 || $diskUsage['percent'] < 100) {
                                ?>
                                <DIV id="uploads" style="overflow:auto !important"
                                     class="wp100 flex-container box--child">
                ...
                <div id="tab-form-4">
                    ...
                    <div class="append relativ" id="appendFile">
                        <div class="fcontainer editItem text-center" data-tip="Material" data-id="0"
                             data-lec="1" title="Добавить материал">
                            <ul id="localFileContainer" style="list-style: none;display: contents">
                                <?php foreach ($localFilesProduct as $localFileProduct) { ?>
                                    <li>
                                        <div href="javascript:void(0)"
                                             style="text-align: left"
                                             id="edit-local-file-<?php echo $localFileProduct["file_id"] ?>">
                                                <span class="flex-container float"
                                                      title="<?php echo $localFileProduct["file_name"] ?>">
                                                    <span class="flex-string w30" style="margin-right:15px">
                                                        <a href="/content/helpers/get.file.php?fid=<?=$localFileProduct["file_id"]?>" target="_blank">
                                                            <i class="icon-eye broun"></i>
                                                        </a></span>
                                                    <span class="flex-string float"><?php echo $localFileProduct["file_name"] ?></span>
                                                    <span class="flex-string float"><?php echo $localFileProduct["ftag"] ?></span>
                                                    <span class="flex-string w30"> <i class="icon-cancel-circled-1 red" onclick="removeSelectedfiles(<?=$localFileProduct["file_id"]?>)"></i></span>
                                                </span>
                                        </div>
                                    </li>
                                <?php } ?>
                            ...
                            <a id="btn-add-lf" href="javascript:void(0)" class="icon-plus btn-add-localfile" onclick="getLocalFiles()">Добавить файл</a>
    ...
    <script>
        ...
        function testtest(item) {
            let localFiles;
            // Uncomment the next line for single selection behavior
            // $('.localfile_name__selected').removeClass('localfile_name__selected');

            // $(this).toggleClass('localfile_name__selected');

            var selectedValue = $(item).data('id');
            var selectedName = $(item).data('name');
            var snippetDescr = $(item).data('descr');


            if (!$("#productLocalFiles").val()) {
                localFiles = [];
            } else {
                localFiles = JSON.parse($("#productLocalFiles").val());
            }

            if (!localFiles.includes(selectedValue)) {

                localFiles.push(selectedValue);

                let html = createLocalFile(selectedName, selectedValue, snippetDescr);
                $("#localFileContainer").append(html);
            } else {
                localFiles = localFiles.filter(item => item !== selectedValue);
                $("#edit-local-file-" + selectedValue).parent().remove();
            }
            $("#productLocalFiles").val(JSON.stringify(localFiles));

            syncHighlightedFiles();
        }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (data.list === null) {
                        ...
                        for (var i = 0; i < data.list.length; i++) {
                            const description = data.list[i].ftag === null ? "" : data.list[i].ftag;
                            ...
                            html += '<tr style="text-align: left" class="localfile_name" onclick="testtest(this)" data-name="' + data.list[i].title + '" data-id="' + data.list[i].id + '" data-descr="' + snipperDescr + '" id="selectLocalFile">';
                            html += '<td>' + data.list[i].datum + '</td>';
                            html += '<td>' + truncateText(data.list[i].title, 20) + '</td>';
                            html += '<td class="truncate-text">' + truncateText(description, 60) + '</td>';
                            html += '<td>' + data.list[i].size + ' Kb</td>';
                            html += '<td><span style="visibility: visible" class="actions"><a href="javascript:void(0)" class="gray green mpr0 cu--preview" data-id="' + data.list[i].id + '" data-type="task" title="Просмотр"><i class="icon-eye green"></i></a></span></td>'
                            html += '</tr>';
                        }
                    ...
                    $(document).on('click', '.gray.green.mpr0.cu--preview', function(event) {
        ...
        function syncHighlightedFiles(deleteOperation = false) {
            let localFiles = $("#productLocalFiles").val() ? JSON.parse($("#productLocalFiles").val()) : [];

            $('.localfile_name').each(function () {
                var fileId = parseInt($(this).data('id'), 10);
                if (localFiles.includes(fileId)) {
        ...
        function removeSelectedfiles(id) {

            let localFiles =  $("#productLocalFiles").val();

            let localFilesArr = JSON.parse(localFiles);

            let indexDeleted = localFilesArr.indexOf(id);

            localFilesArr.splice(indexDeleted,1);

            $("#productLocalFiles").val(JSON.stringify(localFilesArr));

            $("#edit-local-file-"+id).remove();

            syncHighlightedFiles();
        }

        function createLocalFile(name, id,snippetDescr = "") {
            let html = '<li id="local-file-li-'+id+'">';
            html += '<div href="javascript:void(0)" style="text-align: left" id="edit-local-file-' + id + '" class="mat">';
            html += '<span class="flex-container float" title="' + name + '">'
            html += '<span class="flex-string w30" style="margin-right:15px">';
            html += '<a href="/content/helpers/get.file.php?fid='+id+'" target="_blank">'
            html += '<i class="icon-eye broun"></i>'
            html += '</a></span>'
            html += '<span class="flex-string float" style="margin-right: 10px">' + name + '</span>';
            html += '<span class="flex-string float">'+ snippetDescr+'</span>';
            html += '<span class="flex-string w30"> <i class="icon-cancel-circled-1 red" onclick="removeSelectedfiles('+id+')"></i></span>';
            html += '</div>';
            html += '</li>';
            return html;
        }
    ...
    <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="priceForm"
        ...
        <TABLE width="100%" border="0" cellpadding="2" cellspacing="3">
            <TR>
                ...
                <TD>
                    <INPUT name="price_1" type="text" id="price_1" style="width: 195px"
                           value="<?= num_format($price_1) ?>">&nbsp;<?= $valuta ?>
                </td>
            </TR>
            <TR>
                <td colspan="2">
            ...
            <TR>
                <TD valign="top" colspan="2">
                    ...
                    <TEXTAREA name="descr" rows="3" class="required" id="descr"
                              style="width: 98.7%;"><?= $descr ?></TEXTAREA>
                </TD>
            </TR>
        </TABLE>
...
if ($action == "import") {
    ?>
    <FORM action="/modules/modcatalog/form.modcatalog.php" method="post" enctype="multipart/form-data" name="Form"
          id="Form">
        ...
        <div class="infodiv">
            <b>Важно:</b> Допускается импортировать не более 5000 записей за один раз. Поддерживаются форматы XLS. Вы
            можете загрузить
...
if ($action == "import_select") {
    ...
    <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="Form"
          id="Form">
                        ...
                        <td width="200">
                            <select id="field[]" name="field[]" style="width:100%">
                                ...
                                <optgroup label="Общие">
                                    <option value="price:artikul" <?php if (enc_detect($item) == 'Артикул') print "selected"; ?>>
                                        Артикул
                                    </option>
                                    <option value="category:title" <?php if (enc_detect($item) == 'Категория') print "selected"; ?>>
                                        Категория
                                    </option>
                                    <option value="price:title" <?php if (enc_detect($item) == 'Наименование') print "selected"; ?>>
                                        Наименование
                                    </option>
                                    <option value="status:title" <?php if (enc_detect($item) == 'Статус') print "selected"; ?>>
                                        Статус
                                    </option>
                                    <option value="catalog:kol" <?php if (enc_detect($item) == 'Количество') print "selected"; ?>>
                                        Количество
                                    </option>
                                    <option value="price:edizm" <?php if (enc_detect($item) == 'Ед.изм.') print "selected"; ?>>
                                        Ед.измерения
                                    </option>
                                    <option value="price:descr" <?php if (enc_detect($item) == 'Описание краткое') print "selected"; ?>>
                                        Описание краткое
                                    </option>
                                    <option value="catalog:content" <?php if (enc_detect($item) == 'Описание полное') print "selected"; ?>>
                                        Описание полное
                                    </option>
                                </optgroup>
                                <optgroup label="Цены">
...
if ($action == "view") {
    ...
    ?>
    <script>
        let filesDataJSON = '<?php echo json_encode($localFilesProduct) ?>'
        ...
        function createTableFiles(data,sortObj = null){
            ...
            html += '</tbody>';
            html += '</table>';
            $('#view-crm-file').html(html);

        }

        filesDataJSON = JSON.parse(filesDataJSON);
        ...
        function changeCrmSort(field){
            ...
            if(element){
                ...
                createTableFiles(filesDataJSON,{field:field,sort:sort});
            }
        }

        $("#tab-form-5").ready(function (){
            // createTableFiles(filesDataJSON);
        });
    ...
    <div class="flex-container wp100" style="overflow: hidden">
            ...
            <div style="height: 485px;" id="pozition">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="5" id="noborder">
                    ...
                    <tr>
                        ...
                        <td>
                            <b class="red miditxt"><?= num_format($price_1) ?></b> <?= $valuta ?>/<?= $edizm ?>&nbsp;, в
                            т.ч.
                        ...
                        <td>
                            <div id="tagbox">
                                <?php if (in_array('price_2', $don)) { ?>
                                    <div class="tags">
                                        <?= $dname['price_2'] ?>:&nbsp;<b
                                                class="red"><?= num_format($price_2) ?></b> <?= $valuta ?>
                                    </div>
                                <?php } ?>
                                <?php if (in_array('price_3', $don)) { ?>
                                    <div class="tags">
                                        <?= $dname['price_3'] ?>:&nbsp;<b
                                                class="red"><?= num_format($price_3) ?></b> <?= $valuta ?>
                                    </div>
                                <?php } ?>
                                <?php if (in_array('price_4', $don)) { ?>
                                    <div class="tags">
                                        <?= $dname['price_4'] ?>:&nbsp;<b
                                                class="red"><?= num_format($price_4) ?></b> <?= $valuta ?>
                                    </div>
                                <?php } ?>
                                <?php if (in_array('price_5', $don)) { ?>
                                    <div class="tags">
                                        <?= $dname['price_5'] ?>:&nbsp;<b
                                                class="red"><?= num_format($price_5) ?></b> <?= $valuta ?>
                                    </div>
                                <?php } ?>
                            </div>
                        </td>
                            ...
                            <td>
                                <div>
                                    ...
                                    foreach ($files as $file) {
                                        ?>
                                        <div class="tumbs"
                                             style="background: url(<?= '/content/helpers/get.file.php?file=modcatalog/' . $file['file'] ?>) top no-repeat; background-size:cover;">
                                            <a href="<?= '/content/helpers/get.file.php?file=modcatalog/' . $file['file'] ?>"
                                               target="blank" title="В новом окне"><i
                                                        class="icon-search gray icon-3x"></i></a>
                                        </div>
                                    <?php } ?>
                                </div>
                            </td>
        ...
        <div class="flex-string wp60">
            ...
            <DIV id="formtabs" class="wp100" style="background: none;">
                ...
                <UL style="background: none;">
                    ...
                    <LI><A href="#tab-form-5">Файлы</A></LI>
                </UL>
                    ...
                    <table width="98%" border="0" cellspacing="1" cellpadding="4">
                        ...
                        <tr>
                            <td>
                                ...
                                <div class="viewdiv" style="font-size:1.15em; line-height: 1.35em;"
                                     id="htmldiv"><?= $content ?>
                                    <br></div>
                            </td>
                        </tr>
                ...
                <div id="tab-form-5" style="height: 60vh; max-height: 60vh; overflow-y: auto; overflow-x:hidden;"><br/>
                    <div class="fcontainer editItem text-center" data-tip="Material" data-id="0"
                         data-lec="1" title="Добавить материал">
                        <div style="margin-bottom:34px" id="view-crm-file">
        ...
        if (in_array($iduser1, $msettings['mcCoordinator'])) {
            ...
            <div class="pull-aright button--pane" style="width: 100%;text-align: right;">

                <a href="javascript:void(0)"
                   onclick="doLoad('/modules/modcatalog/form.modcatalog.php?n_id=<?= $n_id ?>&action=edit');" class="button"
                   title="Редактировать"><i class="icon-pencil"></i>&nbsp;Редактировать</a>&nbsp;
                <a href="card.modcatalog.php?n_id=<?= $n_id ?>" class="button" title="Карточка" target="blank">Карточка&nbsp;<i
        ...
        <script>
            $(function () {
                ...
                $('#formtabs').tabs().on("click", '[role="tab"]', function() {
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            let filesDataJSONLocal = JSON.parse(response);
                            createTableFiles(filesDataJSONLocal);
                        }
                    })
        ...
        if ($action == "editdop") {
            ...
            <FORM method="post" action="/modules/modcatalog/core.modcatalog.php" enctype="multipart/form-data" name="Form"
                  id="Form">
                ...
                <table width="100%" border="0" cellspacing="2" cellpadding="2">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="summa" id="summa" type="text" class="required" value="<?= $summa ?>"
                                   autocomplete="off">&nbsp;<?= $valuta ?>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr>
                            <b>Описание:</b><br><textarea name="content" rows="3" class="required" id="content"
                                                          style="width: 98.7%;"><?= $content ?></textarea>
                        </td>
                    </tr>
                </table>
                <hr>
        ...
        if ($action == "viewakt") {
            ...
            <div id="formtabse" style="max-height: 80vh; overflow-y: auto; overflow-x: hidden;">
                ...
                if ($tip == 'income') {
                    ...
                    <div class="row">
                        ...
                        <div class="column12 grid-10 fs-12">
                            <a href="javascript:void(0)" onclick="openClient('<?= $posid ?>')"><i
                                        class="icon-building broun"></i><?= current_client($posid) ?>
                            </a></div>
                ...
                if ($tip == 'outcome') {
                    ...
                    <div class="row <?= ($clid > 0 ? '' : 'hidden') ?>">
                        ...
                        <div class="column12 grid-10 fs-12">
                            <a href="javascript:void(0)" onclick="openClient('<?= $clid ?>')"><i
                                        class="icon-building broun"></i><?= current_client($clid) ?>
                            </a></div>
                    ...
                    <div class="row <?= ($did > 0 ? '' : 'hidden') ?>">
                        ...
                        <div class="column12 grid-10 fs-12">
                            <a href="javascript:void(0)" onclick="openDogovor('<?= $did ?>')"><i
                                        class="icon-briefcase broun"></i><?= current_dogovor($did) ?>
                            </a></div>
            ...
            <div class="button--pane text-right">
                ...
                <a href="/modules/modcatalog/printorder.php?id=<?= $id ?>&tip=order" target="_blank" class="button"><i
                            class="icon-print"></i>Распечатать</a>
                ...
                <div id="formtabse" style="overflow-y: auto; max-height: 80vh; height: 80vh">
                    ...
                    <div class="row">
                        ...
                        <?php if ($tip == 'income') { ?>
                            ...
                            <?php if ($id < 1) { ?>
                                ...
                                <div id="filee" style="width:97%">
                                    ...
                                    <div class="column12 grid-10">
                                        <input name="file" type="file" class="file" id="file" style="width:97%"
                                               onchange="upload()"/>
                                    </div>
                                </div>
                        ...
                        <?php if ($tip == 'outcome') { ?>
                            ...
                            <div class="column12 grid-10">
                                <input name="dogovor" type="text" id="dogovor" style="width: 97%;"
                                       value="<?= current_dogovor($did) ?>" placeholder="Начните вводить название">
        ...
        if ($action == "editaktperpoz") {
            ...
            <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="Form"
                ...
                <div align="right" class="button--pane">
                    ...
                    <A href="javascript:void(0)" onclick="Save()" class="orangebtn button"
                       title="Окно редактора не будет закрыто">Сохранить и продолжить</A>&nbsp;
            ...
            <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="Form"
                ...
                <div style="width:99.2%; padding:5px; overflow-y: auto; overflow-x: hidden; max-height: 400px;" id="formtabse">
                    ...
                    <div class="row">
                        ...
                        <div class="column12 grid-4">
                            <input type="text" name="datum_priority" id="datum_priority" value="<?= $datum_priority ?>"
                                   class="yw80 datum">
                            &nbsp;&nbsp;
                        ...
                        if (in_array($iduser1, $msettings['mcCoordinator'])) {
                            ...
                            <div class="hidden1">
                                <div class="row greenbg-sub pb10">
                                    ...
                                    <div class="column12 grid-10">
                                        <input name="contractor" type="text" id="contractor" style="width: 97%;"
                                               value="<?= current_client($conid) ?>"
                                               placeholder="Начните вводить название. Например: Сэйлзмэн">
                                    ...
                                    <div class="column12 grid-4">
                                <span class="tooltips"
                                      tooltip="<blue>Что это?</blue><hr>При выполнении заявки в Бюджет будет добавлен новый расход на указанную сумму. Если заявка привязана к сделке, то также будет добавлен расход к Сделке"
                                      tooltip-position="bottom"><input type="text" name="cSumma" id="cSumma"
                                                                       value="<?= num_format($cSumma) ?>"><i
                                            class="icon-info-circled blue"></i></span>
                                    </div>
                    ...
                    if ($tip == 'cold') {
                        ...
                        <div class="row">
                            ...
                            <div class="column12 grid-10">
                                <input type="text" name="zTitle" id="zTitle" value="<?= $zayavka['zTitle'] ?>"
                                       style="width:98.7%">
                            </div>
                            ...
                            <div class="column12 grid-10">
                                <input type="text" name="zProbeg" id="zProbeg" value="<?= $zayavka['zProbeg'] ?>"
                                       style="width:100px">
                            </div>

                            <div class="column12 grid-2 fs-12 pt10 right-text">Цена от:</div>
                            <div class="column12 grid-2">
                                <input type="text" name="zPriceStart" id="zPriceStart" value="<?= $zayavka['zPriceStart'] ?>"
                                       style="width:150px">
                            </div>
                            <div class="column12 grid-1 fs-12 pt10 right-text">До:</div>
                            <div class="column12 grid-6">
                                <input type="text" name="zPriceEnd" id="zPriceEnd" value="<?= $zayavka['zPriceEnd'] ?>"
                                       style="width:150px">
                    ...
                    if ($tip != 'cold') {
                        ...
                        <div class="row">
                            ...
                            <div class="column12 grid-4 hidden">
                                <input name="client" type="text" id="client" style="width: 97%;"
                                       value="<?= current_client($clid) ?>"
                                       placeholder="Начните вводить название. Например: Сэйлзмэн">
                            ...
                            <div class="column12 grid-10">
                                ...
                                &nbsp;<a href="javascript:void(0)" onclick="specaLoad2()" title="Загрузить снова"><i
                                            class="icon-ccw blue"></i></a>&nbsp;
                                <span class="tooltips"
                                      tooltip="<blue>Что это?</blue><hr>Список сделок с этапом более <?= $msettings['mcStepPers'] ?>%, имеющие не размещенные в заявках позиции"
                                      tooltip-position="left" style="width:100%;"><i class="icon-info-circled blue"></i></span>
                    ...
                    <?php if (in_array($iduser1, $msettings['mcCoordinator'])) { ?>
                        ...
                        <div class="row hidden">
                            ...
                            <div class="column12 grid-12">
                        <TEXTAREA name="zAnswer" rows="3" id="zAnswer"
                                  style="width: 99.7%;"><?= $zayavka['zAnswer'] ?></TEXTAREA>
                            </div>
                        ...
                        <div class="row hidden">
                            ...
                            <div class="column12 grid-4">
                                ...
                                <input type="hidden" name="zCoordinator" id="zCoordinator"
                                       value="<?= $zayavka['zCoordinator'] ?>">
                            </div>
        ...
        if ($action == "editzayavkastatus") {
            ...
            <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="Form"
                ...
                <div id="formtabs" style="width:100%; max-height: 80vh; overflow-y: auto; overflow-x: hidden;">
                    ...
                    <span class="tooltips"
                          tooltip="<blue>Что это?</blue><hr>При выполнении заявки в Бюджет будет добавлен новый расход на указанную сумму. Если заявка привязана к сделке, то также будет добавлен расход к Сделке"
                          tooltip-position="bottom"><input type="text" name="cSumma" id="cSumma" value="<?= $cSumma ?>"><i
                                class="icon-info-circled blue"></i></span>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="column12 grid-12">
                    <TEXTAREA name="zAnswer" rows="3" id="zAnswer"
                              style="width: 98.7%;"><?= $zayavka['zAnswer'] ?></TEXTAREA>
                        </div>
                    ...
                    <div class="infodiv <?php if ($isCold != 'true')
                        ...
                        <b class="red">Внимание!</b> Для заявок на поиск после сохранения будет открыта форма добавления позиции
                        в каталог
        ...
        if ($action == "editzayavkacomplete") {
			...
			";
                ...
                <div class="button--pane text-right">
                    ...
                    <a href="javascript:void(0)" onclick="openDogovor('<?= $did ?>')" class="button"><i
                                class="icon-briefcase"></i>Карточка <?= $lang['face']['DealName'][1] ?></a>
            ...
            <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="Form"
                ...
                <div id="formtabse">
                    ...
                    <div class="row">
                        ...
                        <div class="column12 grid-8">
                            <input type="text" name="date_out" id="date_out" value="<?= $data['date_out'] ?>"
                                   class="wp50 datum">
                        </div>
                        ...
                        <div class="column12 grid-8">
                            <input type="text" name="date_create" id="date_create" value="<?= $data['date_create'] ?>"
                                   class="wp50 datum">
                        </div>

                        <div class="column12 grid-4 fs-12 pt10 right-text">Дата поверки:</div>
                        <div class="column12 grid-8">
                            <input type="text" name="date_period" id="date_period" value="<?= $data['date_period'] ?>"
                                   class="wp50 datum">
                        </div>
                        ...
                        <div class="column12 grid-8">
                            <input type="text" name="dogovor" id="dogovor" value="<?= current_dogovor($data['did']) ?>"
                                   class="wp90">
            ...
            <div id="formtabse" style="max-height: 80vh; overflow-y: auto; overflow-x: hidden;" class="pad5">
                ...
                <?php if ($conid > 0) { ?>
                    <div class="row">
                        ...
                        <div class="column12 grid-9 fs-12">
                            <a href="javascript:void(0)" onclick="openClient('<?= $conid ?>')"><i
                                        class="icon-building blue"></i><b><?= current_client($conid) ?></b></a>
                        </div>
                ...
                <?php if ($clid > 0) { ?>
                    <div class="row">
                        ...
                        <div class="column12 grid-9 fs-12">
                            <a href="javascript:void(0)" onclick="openClient('<?= $clid ?>')"><i
                                        class="icon-building broun"></i><b><?= current_client($clid) ?></b></a>
                        </div>
                ...
                <?php if ($did > 0) { ?>
                    <div class="row">
                        ...
                        <div class="column12 grid-9 fs-12">
                            <a href="javascript:void(0)" onclick="openDogovor('<?= $did ?>')"><i
                                        class="icon-briefcase broun"></i><b><?= current_dogovor($did) ?></b></a>
                        </div>
            ...
            <div class="button--pane">
                ...
                <div class="pull-aright">
                    ...
                    <?php if (in_array($status, [0, 1])) { ?>
                        <a href="javascript:void(0)"
                           onclick="doLoad('/modules/modcatalog/form.modcatalog.php?id=<?= $id ?>&action=editzayavkastatus')"
                           class="button">Обработать</a>&nbsp
                    <?php } ?>
            ...
            <TABLE id="bborder">
                ...
                <?php if ($clid > 0) { ?>
                    <tr height="25">
                        ...
                        <td>
                            <a href="javascript:void(0)" onclick="openClient('<?= $clid ?>')"><i
                                        class="icon-commerical-building broun"></i><b><?= current_client($clid) ?></b></a>
                        </td>
                    </tr>
                <?php } ?>
                <?php if ($did > 0) { ?>
...
<tr height="40" class="ha">
	...
	<td align="center">' . num_format($data['kol']) . '</td>
            ...
            <div id="formtabse">
                ...
                <div class="row">
                    ...
                    <div class="column12 grid-8 fs-12">
                        <a href="javascript:void(0)" onclick="openDogovor('<?= $data['did'] ?>')"><i
                                    class="icon-briefcase broun"></i><?= current_dogovor($data['did']) ?>
                        </a></div>
        ...
        if ($action == "editoffer") {
            ...
            <FORM action="/modules/modcatalog/core.modcatalog.php" method="post" enctype="multipart/form-data" name="Form"
                    ...
                    <TABLE>
                        ...
                        <?php if ($msettings['mcOfferName1'] != '') { ?>
                            <tr height="30">
                                ...
                                <td colspan="3">
                                    <input type="text" name="zGod" id="zGod" value="<?= $zayavka['zGod'] ?>"
                                           style="width:200px">
                                    &nbsp;<b><?= $msettings['mcOfferName2'] ?>:</b>&nbsp;<input type="text" name="zProbeg"
                                                                                                id="zProbeg"
                                                                                                value="<?= $zayavka['zProbeg'] ?>"
                                                                                                style="width:200px">
                                </td>
                            </tr>
                        <?php } ?>
                        <tr height="30">
                            ...
                            <td colspan="3">
                                <input type="text" name="zPrice" id="zPrice" value="<?= $zayavka['zPrice'] ?>"
                                       style="width:150px">
                                <label><input type="checkbox" name="zNDS" id="zNDS" <?php if ($zayavka['zNDS'] = 'yes')
                        ...
                        <TR height="30">
                            ...
                            <TD colspan="3">
                                ...
                                <div class="infodiv" style="width:96.7%">Допускается наличие 1 изображения. В случае замены
                        ...
                        <TR>
                            <TD valign="top" colspan="4">
                                ...
                                <TEXTAREA name="content" id="content"
                                          style="width: 98.7%; height:160px"><?= $content ?></TEXTAREA>
                            </TD>
                        </TR>
                    </TABLE>
                </div>
                ...
                <div class="button--pane text-right">
                    ...
                    <span id="submitbutton" class="hidden1"><A href="javascript:void(0)" onclick="$('#Form').trigger('submit')"
                                                               class="button">Сохранить</A>&nbsp;</span>
                </div>
            </FORM>
            <script>
                    ...
                    <TABLE width="100%" border="0" cellpadding="2" cellspacing="1" id="bborder">
                        ...
                        <?php if ($msettings['mcOfferName1'] != '') { ?>
                            <tr height="30">
                                ...
                                <td colspan="3">
                                    <div class="fpoleCold">
                                        <b><?= $zayavka['zGod'] ?></b>,&nbsp;<?= $msettings['mcOfferName2'] ?>
                                        :&nbsp;<b><?= $zayavka['zProbeg'] ?></b>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr height="30">
                                ...
                                <td colspan="3">
                                    <div class="fpoleCold" style="max-height: 250px;">
                                        <a href="javascript:void(0)"
                                           onclick="doLoad('modcatalog/editor.php?action=view&n_id=<?= $prid ?>');"><i
                                                    class="icon-archive broun"></i><?= $prtitle ?>
                                        </a></div>
                                </td>
                            </tr>
                        <?php } ?>
        ...
        <?php if ($prid == 0) { ?>
            ...
            <span id="orangebutton" style="font-size:0.95em;"><A href="javascript:void(0)"
                                                                 onclick="doLoad('/modules/modcatalog/form.modcatalog.php?ido=<?= $id ?>&action=edit');"
                                                                 class="button" title="В каталог">В каталог</A></span>
            </div>
        <?php } ?>
            <script>
        ...
        <form action="/modules/modcatalog/core.modcatalog.php" id="Form" name="Form" method="post"
